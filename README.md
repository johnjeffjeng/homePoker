...
* No [ratholing](http://poker.wikia.com/wiki/Ratholing). Chips must remain in play until a player cashes out.

## Blinds
* We use the “[dead button](http://www.homepokertourney.com/button.htm)” rule (continuity of blinds). The alternative rule, the “moving button”, is fairer but complicated for newer players and slows down the game.
...
## Common Discrepancies Between Home Games
